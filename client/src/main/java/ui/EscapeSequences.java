...
public class EscapeSequences {
    ...
    public static final String SET_TEXT_COLOR_LIGHT_GREY = SET_TEXT_COLOR + "250m";
    public static final String SET_TEXT_COLOR_DARK_GREY = SET_TEXT_COLOR + "236m";
    ...
    public static final String SET_BG_COLOR_LIGHT_GREEN = SET_BG_COLOR + "123m";
